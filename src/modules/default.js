...
const createDefault = (() => {
  const dProject = () => {
    if (localStorage.length === 0) {
      ...
      const t1 = new Todo('Concatenate Conference', 'With standup team', new Date('2020-10-1'), 'High');
      const t2 = new Todo('Rails Meetup', 'With students', new Date('2020-9-25'), 'Medium');
